<?php
/**
 * WHMCS Public Invoice Link - Invoice PDF Template
 * 
 ...
 */
  ...
  require_once(dirname(__FILE__) . "/../../modules/addons/publicInvoiceLink/models/pilink_access.php");
...
if ($status == "Unpaid") {
    ...
    $pdf->Ln(5);  
    $pdf->Cell(150,'');
    $pdf->Cell(30,5,"Pay Invoice",1,0,'C',true, $autolink);
}
